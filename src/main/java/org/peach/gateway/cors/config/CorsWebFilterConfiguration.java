package org.peach.gateway.cors.config;
 ...
 * </p>
 * <p>
 * 规则绑定 {@link CorsProperties}（{@code peach.gateway.cors}）。勿再使用已废弃的
...
public class CorsWebFilterConfiguration {
	...
	public CorsWebFilter peachGatewayCorsWebFilter(CorsProperties properties) {
	...
	static CorsConfiguration toCorsConfiguration(CorsProperties properties) {
