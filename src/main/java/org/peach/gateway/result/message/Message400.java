...
/**
 * 网关侧 4xx 语义类消息末段与文案；通过 {@link org.peach.gateway.result.web.ErrorResult#validWarn(MessageCode)}、
 * {@link org.peach.gateway.result.web.ErrorResult#unauthorized(MessageCode)} 等与模块前缀及 HTTP 状态数字拼接为完整
